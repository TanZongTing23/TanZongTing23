...
class MainActivity6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val backBtn: Button = findViewById(R.id.backToCalculatorBtn2)

        val loanAmountGenerate: TextView = findViewById(R.id.loanAmountGenerate2)
        val interestGenerate: TextView = findViewById(R.id.interestGenerate2)
        val loanTenureGenerate: TextView = findViewById(R.id.loanTenureGenerate2)
